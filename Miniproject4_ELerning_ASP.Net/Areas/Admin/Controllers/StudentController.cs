...
namespace Miniproject4_ELerning_ASP_MVC.Areas.Admin.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Create(StudentCreateVM request)
        {
            ...
            await _studentService.CreateAsync(new Student { FullName = request.FullName,
                                                           Profession = request.Profession,
                                                           Image = fileName, Biography = request.Biography });
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            //return View();
            return View(new StudentEditVM { FullName = student.FullName,
                                          Profession = student.Profession, 
                                           Image = student.Image, Biography = student.Biography });
        }
